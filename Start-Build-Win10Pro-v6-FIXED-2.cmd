...
:: ------------------------------------------------------------
if not exist "%~dp0Build-Win10Pro-v6-FIXED-2.ps1" (
    echo [ERROR] Build-Win10Pro-v6-FIXED-2.ps1 was not found.
    echo.
    pause
    exit /b 1
)
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0Build-Win10Pro-v6-FIXED-2.ps1"
